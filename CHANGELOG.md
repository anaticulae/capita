...
* upgrade requirements.txt (b4ae278d4781)
* upgrade Jenkinsfile (ffeff1cea035)
* upgrade pipe library (c2065f4e4ca7)

## v1.23.2 (2022-12-21)

### Chore

* upgrade requirements.txt (3f8f26ce0b8c)
* upgrade pipeline (98fe98701c57)
